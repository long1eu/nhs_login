...
import 'package:nhs_login/src/models/nhs_authentication_response.dart';
...
class NhsLogin {
  ...
  Future<NhsAuthenticationResponse> login(NhsAuthentication authentication) {
  ...
  Future<NhsTokenResponse> getToken(NhsAuthenticationResponse authResponse) async {
    ...
    if (response.statusCode == 200) {
      return NhsTokenResponse.fromJson(jsonDecode(body));
    } else {
      throw StateError(
          'Coundn\'t get a valid token ${response.statusCode}. Got error: ${body}');
    }
  }
}
